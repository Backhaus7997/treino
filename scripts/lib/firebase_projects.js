...
function bannerDeProduccion(projectId, { contraEmulador = false } = {}) {
  ...
  return [
    ...
    '🚨  It is TREINO\'s only Firebase project — there is no treino-prod.',
    '🚨  Admin SDK writes bypass the Firestore rules.',
    '🚨',
    '🚨  Firestore backup: daily schedule, 28-day retention — a restore is',
    '🚨  possible but costly. It does NOT cover Cloud Storage or Auth users:',
    '🚨  what a script does there is gone for good.',
    '🚨',
