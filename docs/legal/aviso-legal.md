...
que además pone en contacto a personas que entrenan con entrenadores personales
independientes.

**BACKHAUSTIN S.A.S. no presta servicios de salud, no ejerce ninguna profesión
de la salud, y no intermedia los pagos entre alumnos y entrenadores.** Ver el
[Descargo Médico](./descargo-medico.md) y los
...
- [Normas de Comunidad](./normas-de-comunidad.md)
- [Descargo Médico](./descargo-medico.md)
- [Retención y borrado de datos](./retencion-y-borrado.md)

## Autoridades

- **Protección de datos personales:** Agencia de Acceso a la Información
  Pública (AAIP), República Argentina.
- **Defensa del consumidor:** la autoridad de aplicación que corresponda al
