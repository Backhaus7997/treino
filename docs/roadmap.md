...
| Fase 7 (Monetización + Lanzamiento beta) | ⏳ **Desbloqueada** — TestFlight build & submit como primer step (provisioning + App Store Connect + build number + smoke final + submit), después pagos / verificación / deep links / app icon / screenshots / Gemini Excel / group chats | — | Proyectada ~2026-06-30 |
