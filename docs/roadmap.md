...
- [x] **Fase 6** — Producto-ready para beta. ✅ **COMPLETA (mobile)** 2026-06-12 (9 etapas core) + 1 etapa extra post-cierre (Etapa 10 chat-media, 2026-06-19) = **10/10 etapas mobile**: **Trainer profile UI ✅** · **Push notifications ✅** · **Coach Hub polish ✅** · **Recurring appointments ✅** · **Excel polish + aliases dinámicos ✅** · **App Check + Crashlytics + Analytics ✅** · **Reviews/ratings de PFs ✅** · **i18n mobile ✅** (5 PRs #146/#147/#150/#152/#154) · **Athlete self-routines ✅** (+ extensión home 2026-06-18: #191 today's routine + #193 active marker) · **Chat con media ✅** (#194 data + #195 UI). **Polish post-build #2 (2026-06-19)**: Insights con taxonomía granular de 10 grupos (#196) + chat unread-count badges (#197, cierra el out-of-scope explícito del SDD chat-media) + body highlighting dinámico con masks proporcionales al cumplimiento de plan en Insights + Home (#198, incluye nuevo asset `mask_back_triceps.png`). **Deferred**: i18n Coach Hub web (~55 keys, 5 archivos) — mini-SDD futuro cuando W1.x estabilice copy. **TestFlight builds delivered**: #1 (`0.1.0+1`, 2026-06-17, 86 MB IPA, 1 ITMS-90683 location flag — non-blocking) → **#2 (`0.1.0+2`, 2026-06-18, 80 MB IPA, cero ITMS warnings)** con fix de location + extensiones home + chat-media, live en Internal Beta con 8 testers.
