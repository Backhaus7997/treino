...
- [x] **Fase 6** — Producto-ready para beta. ✅ **COMPLETA (mobile)** 2026-06-12 — 9/9 etapas mobile cerradas: **Trainer profile UI ✅** · **Push notifications ✅** · **Coach Hub polish ✅** · **Recurring appointments ✅** · **Excel polish + aliases dinámicos ✅** · **App Check + Crashlytics + Analytics ✅** · **Reviews/ratings de PFs ✅** · **i18n mobile ✅** (5 PRs #146/#147/#150/#152/#154) · **Athlete self-routines ✅**. **Deferred**: i18n Coach Hub web (~55 keys, 5 archivos) — mini-SDD futuro cuando W1.x estabilice copy; prioridad TestFlight = mobile, web puede esperar. **TestFlight build #1 delivered 2026-06-17** (`0.1.0+1`, 86 MB IPA, ready for internal testing).
...
| Fase 6 (Producto-ready: trainer UI + push + agenda recurrente + telemetría + reviews + i18n) | ✅ **CERRADA (mobile)** 2026-06-12 — Etapa 6 telemetría ✅ (Crashlytics #108, Analytics #109, App Check #110); Etapa 7 reviews ✅ 2026-06-02 (`trainer-reviews`); Etapa 4 recurring ✅ 2026-06-04 (trainer-driven eager + cancel-serie); Etapa 2 push notifications ✅ 2026-06-04 (`push-notifications-fcm`, 4 PRs + archive `4551868`); Etapa 1 trainer profile UI ✅ 2026-06-08 (`trainer-profile-onboarding`, 2 PRs #139 #141 + archive `aaf5243`); **Etapa 3 Coach Hub polish ✅ confirmada 2026-06-09 vía audit profundo (PR#134 data + PR#135 CF + PR#138 UI)**; Etapa 9 self-routines ✅ + supersets en self-create (#137); **Etapa 5 Excel polish + aliases dinámicos ✅ 2026-06-09** (`coach-excel-polish` SDD: catalog #136 + template #142 + addAlias CF #143 + client wire #144); **Etapa 8 i18n mobile ✅ 2026-06-12** (5 PRs #146/#147/#150/#152/#154, ~250 keys ARB, suite 2052→2328). **Coach Hub web i18n deferred a mini-SDD futuro** (audit completo en Engram, sin urgencia — esperar a W1.x estabilización; mobile es la prioridad de TestFlight). **Ready for TestFlight build**. | ✅ 2026-06-12 | Proyectada ~2026-06-15 — **3 días adelantada** |
| Fase 7 (Monetización + Lanzamiento beta) | 🔄 **En curso — TestFlight build #1 DELIVERED 2026-06-17** (`0.1.0+1`, App ID `6781307745`, app name "TREINO Fitness" en App Store Connect porque "TREINO" estaba ocupado, primary language Spanish (Mexico)). Pre-build polish wave incluida: bleed-through fix (#166), exercise name fallback + asset cascade con `assets/muscles/` movement patterns (#176), branded icon TR mint (#178), Info.plist permissions + Export Compliance + iOS 14.0 deployment + aps-environment production (#164), audit batches HIGH-severity findings (#171 a11y · #174/#177 usability · #179 states · #94bc049 navigation · #737cb5f error-prevention) · full-screen mis-ejercicios/mensajes (#183) · custom exercise muscle taxonomy unification con secondary muscle + equipment (#186 / `51973bc`). **Post-upload**: Apple flag ITMS-90683 (location key faltante por geolocator SDK reference) — non-blocking para Internal pero fix ya en main (#182 / `2b831f2`) para build #2. **Next**: smoke en device real via TestFlight Internal → iteración de bugs → build #2 (incluye ITMS fix + lo que salga del smoke) → eventualmente External Testing (requiere Privacy Policy URL + Beta App Review). Después: pagos (Mercado Pago/Stripe), verificación profesional, deep links, screenshots para store, Gemini Excel (cuando GCP esté activo), group chats, video calls. | 🔄 build #1 entregado 2026-06-17 | Proyectada ~2026-06-30 para TestFlight Internal estable |
