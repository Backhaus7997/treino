...
- [ ] **Fase 6** — Producto-ready para beta. 🔄 **8 etapas planeadas + 1 emergente (athlete-self-routines)**: **Trainer profile UI ✅** · **Push notifications ✅** · **Coach Hub polish ✅** · **Recurring appointments ✅** · **Excel polish + aliases dinámicos 🔄** (catalog import done, Excel template + addAlias CF pendientes) · App Check + Crashlytics + Analytics ✅ · **Reviews/ratings de PFs ✅** · i18n (es-AR oficial + scaffold inglés) · **Athlete self-routines ✅** (+ supersets en self-create #137).
...
| **B** | Etapa 1 (Trainer profile UI) ✅ (entregada por Dev C) + **Etapa 3 (Coach Hub polish)** ✅ + Etapa 5 (Excel polish + aliases dinámicos) 🔄 (catalog #136 done, template + CF pendientes) — track Coach Hub + onboarding del PF |
