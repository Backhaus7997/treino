...
// ─────────────────────────────────────────────────────────────────────────────
//  ⚠️ ESTE ARCHIVO LO COMPILA `conformance/run_swift.sh`, SOLO.
//
//  Sin la app, sin SwiftUI, sin Firestore. Es lo que hace que el contrato
//  compartido se ejercite de verdad en CI sobre ubuntu, sin una Mac.
//
//  **No le agregues nada que dependa de la app.** Ya pasó: el envoltorio que
//  consigue el entitlement vivía acá y el job se puso rojo con cinco
//  `cannot find type ... in scope`. Ese código vive ahora en
//  `CatalogGateWiring.swift`, que el runner NO compila.
//
//  La regla, dicha simple: acá entra lo que se puede decidir con los tres
//  booleanos del fixture y nada más.
// ─────────────────────────────────────────────────────────────────────────────
