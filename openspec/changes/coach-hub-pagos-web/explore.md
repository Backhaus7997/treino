...
| WhatsApp athlete phone number | High | `wa.me/{phone}` requires the athlete's phone. Athlete phone is NOT in `UserPublicProfile`. Options: (a) open WhatsApp without pre-selecting contact (wa.me without number), (b) WhatsApp share link (message only, user picks contact), (c) store phone in a new field. |
