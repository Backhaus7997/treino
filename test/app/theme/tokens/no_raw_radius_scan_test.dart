...
/// `docs/design-system.md` los documenta como escala CERRADA. Al escribirse este
/// test la adopción era ~10%: 678 literales `Radius.circular(N)` repartidos en
/// 149 archivos de `lib/`, contra 71 usos de `AppRadius.*`.
///
...
void main() {
  group('no_raw_radius_scan — prohibición de Radius.circular(<literal>)', () {
    ...
    const rawRadiusDebtCeiling = 678;
