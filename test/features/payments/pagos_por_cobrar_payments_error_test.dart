...
//
// Slice 1 (2026-07): the recurring/virtual charge logic this guarded against
// re-surfacing was removed entirely (pagosPorCobrarProvider no longer watches
// billing config), so the athleteBillingProvider override was dropped from
// this harness — only trainerLinksStreamProvider + trainerPaymentsProvider
// (the two streams the provider still reads) are exercised here.
