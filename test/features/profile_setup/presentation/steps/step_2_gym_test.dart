...
void main() {
  ...
  List<Override> baseOverrides() => [
        ...
        placesAutocompleteServiceProvider.overrideWithValue(mockPlacesService),
  ...
  group('Step2Gym', () {
    ...
    testWidgets(
        'typing shows debounced Autocomplete suggestions without requesting '
    ...
    testWidgets(
        'selecting a suggestion resolves it and sets draft.gymId to the '
        "Place's id", (tester) async {
      when(() => mockPlacesService.search(
            query: any(named: 'query'),
            sessionToken: any(named: 'sessionToken'),
            biasLatitude: any(named: 'biasLatitude'),
