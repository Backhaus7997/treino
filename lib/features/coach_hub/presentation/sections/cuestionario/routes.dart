...
/// Rutas e item de sidebar de la sección «Cuestionario» del Coach Hub web.
///
...
final List<RouteBase> cuestionarioRoutes = [
  GoRoute(
    path: '/cuestionario',
    pageBuilder: (_, __) => coachHubPage(
        const ProximamenteScreen(label: 'Cuestionario')), // i18n: Fase W1
  ),
  // TODO(W2+): wire real screen
];

const List<SidebarItem> cuestionarioSidebarItems = [
  SidebarItem(
    id: 'cuestionario',
    label: 'Cuestionario', // i18n: Fase W1
    route: '/cuestionario',
    iconBuilder: _cuestionarioIcon,
    group: SidebarGroup.alumnos,
  ),
];

IconData _cuestionarioIcon() => TreinoIcon.sidebarCuestionario;
