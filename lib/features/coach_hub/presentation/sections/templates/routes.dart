...
/// Rutas e item de sidebar de la sección «Templates» del Coach Hub web.
///
...
final List<RouteBase> templatesRoutes = [
  GoRoute(
    path: '/templates',
    builder: (_, __) =>
        const ProximamenteScreen(label: 'Templates'), // i18n: Fase W1
  ),
  // TODO(W2+): wire real screen
];

const List<SidebarItem> templatesSidebarItems = [
  SidebarItem(
    id: 'templates',
    label: 'Templates', // i18n: Fase W1
    route: '/templates',
    iconBuilder: _templatesIcon,
    group: SidebarGroup.plan,
  ),
];

IconData _templatesIcon() => TreinoIcon.sidebarTemplates;
