...
///
/// Fase 10 (WU-03): la ruta renderiza [PlanesScreen] real. Cada sección posee
/// su propio archivo para que los PRs paralelos no choquen en
/// `coach_hub_router.dart` ni en `sidebar_registry.dart` (ADR-CHW-002).
final List<RouteBase> planesRoutes = [
  GoRoute(
    path: '/planes',
    pageBuilder: (_, __) => coachHubPage(const PlanesScreen()),
  ),
];
