...
class _FilasSkeleton extends StatelessWidget {
  const _FilasSkeleton();

  /// Seis filas: alcanza para llenar el alto del panel sin que el shimmer
  /// parezca una lista corta que ya cargó.
  static const filas = 6;
