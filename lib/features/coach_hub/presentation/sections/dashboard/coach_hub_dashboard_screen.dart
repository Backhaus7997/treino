...
///
/// Renders the shared [PendingRequestsList] (extracted to
/// `presentation/widgets/pending_requests_list.dart` so `/solicitudes`,
/// reached from the top-bar bell, reuses the same accept/decline logic).
