...
class DashboardKpiStrip extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final adherenceLabel = adherenceValue == null
        ...
        // #582: clamp a 100%, igual que el anillo de la welcome card. El valor
        // crudo puede pasarse de 100 cuando el alumno loguea más sesiones que
        // las planificadas; sin este clamp el anillo y la KPI muestran números
