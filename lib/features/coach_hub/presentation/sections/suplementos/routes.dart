...
/// Rutas e item de sidebar de la sección «Suplementos» del Coach Hub web.
///
...
final List<RouteBase> suplementosRoutes = [
  GoRoute(
    path: '/suplementos',
    builder: (_, __) =>
        const ProximamenteScreen(label: 'Suplementos'), // i18n: Fase W1
  ),
  // TODO(W2+): wire real screen
];

const List<SidebarItem> suplementosSidebarItems = [
  SidebarItem(
    id: 'suplementos',
    label: 'Suplementos', // i18n: Fase W1
    route: '/suplementos',
    iconBuilder: _suplementosIcon,
    group: SidebarGroup.wellness,
  ),
];

IconData _suplementosIcon() => TreinoIcon.sidebarSuplementos;
