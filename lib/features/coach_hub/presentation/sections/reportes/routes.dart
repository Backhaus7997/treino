...
/// Rutas e item de sidebar de la sección «Reportes» del Coach Hub web.
///
...
final List<RouteBase> reportesRoutes = [
  GoRoute(
    path: '/reportes',
    builder: (_, __) =>
        const ProximamenteScreen(label: 'Reportes'), // i18n: Fase W1
  ),
  // TODO(W2+): wire real screen
];

const List<SidebarItem> reportesSidebarItems = [
  SidebarItem(
    id: 'reportes',
...
IconData _reportesIcon() => TreinoIcon.sidebarReportes;
